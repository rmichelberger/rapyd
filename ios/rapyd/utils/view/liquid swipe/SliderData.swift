...
struct Config {
    ...
    //    static let leftWaveY = 300.0
    //    static let rightWaveY = 300.0
    
    static let leftWaveY = SliderData.height - 100
    static let rightWaveY = SliderData.height - 100
    ...
    private static let COLORS =  [
        0x0074D9, 0x7FDBFF, 0x39CCCC, 0x3D9970, 0x2ECC40,
        0xFFDC00, 0xFF851B, 0xFF4136, 0xF012BE, 0xB10DC9
    ]
    ...
    static func shuffleColors() {
        colors.shuffle()
//        colors = colors.shuffled()
    }
    
    static func color(hash: Int) -> Color {
        COLORS[hash % COLORS.count]
    }
...
struct SliderData {
    ...
    func initialAnimation() -> SliderData {
        return SliderData(side: side, centerY: centerY, progress: 0.2)
    }
